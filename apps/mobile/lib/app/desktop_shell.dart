      ...
      builder: (context, constraints) {
        ...
        return CallbackShortcuts(
          bindings: <ShortcutActivator, VoidCallback>{
            ...
            const SingleActivator(LogicalKeyboardKey.f4): () => context.go('/customers'),
...
const _items = <_DesktopNavItem>[
  ...
  _DesktopNavItem(label: 'Customers', path: '/customers', icon: Icons.groups_2_outlined, shortcut: 'F4'),
